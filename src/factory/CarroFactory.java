...
public class CarroFactory {
    ...
    public static Carro criarCarro(String marca, String modelo, int anoFabricacao, String placa, double precoDiaria, boolean disponivel, int numeroPortas, String tipoCombustivel) {
